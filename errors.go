...
// NewHuefyError creates a new generic Huefy error
func NewHuefyError(message string, code string) *HuefyError {
	return &HuefyError{
		Code:    ErrorCode(code),
		Message: message,
	}
...
func createErrorFromResponse(errorResp *ErrorResponse) error {
